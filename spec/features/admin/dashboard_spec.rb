...
RSpec.describe 'Admin Dashboard' do
  describe 'As an Admin' do
    before :each do
      ...
      @address = @m_user.addresses.create(address: '123 Main St', city: 'Denver', state: 'CO', zip: 80218)
      ...
      @order_1 = @m_user.orders.create!(status: "packaged", address: @address)
      @order_2 = @m_user.orders.create!(status: "pending", address: @address)
      @order_3 = @m_user.orders.create!(status: "cancelled", address: @address)
