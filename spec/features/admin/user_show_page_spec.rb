...
RSpec.describe 'User Show Page' do
  describe 'As an Admin' do
    before :each do
      ...
      @d_address = @d_user.addresses.create(address: '123 Main St', city: 'Denver', state: 'CO', zip: 80218)
    ...
    it 'I see all info a user sees, without edit ability' do
      ...
      expect(page).to have_content(@d_address.address)
      expect(page).to have_content("#{@d_address.city}, #{@d_address.state}")
