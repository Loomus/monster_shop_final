...
RSpec.describe 'Merchant Show Page' do
  describe 'As a visitor' do
    before :each do
      ...
      @address = @user_1.addresses.create!(address: '123 Main St', city: 'Denver', state: 'CO', zip: 80218)
      @address_2 = @user_2.addresses.create!(address: '123 Main St', city: 'Denver', state: 'IA', zip: 80218)
      @order_1 = @user_1.orders.create!(address: @address)
      @order_2 = @user_2.orders.create!(address: @address_2)
      @order_2 = @user_2.orders.create!(address: @address_2)
